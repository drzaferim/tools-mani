...
const labels = {
  ...
  es: {
    ...
    subtitle:
      "Convierte cualquier imagen cuadrada en un conjunto completo de favicons: favicon.ico, PNG en todos los tamaños estándar y las etiquetas HTML listas para pegar. Todo se genera en tu navegador.",
    drop: "Suelta una imagen aquí o haz clic para seleccionarla",
    formats: "PNG, JPG o WebP — idealmente 512×512 o mayor",
    generate: "Generar favicons",
    processing: "Generando...",
    downloadZip: "Descargar ZIP",
    preview: "Vista previa",
    htmlTitle: "Etiquetas HTML (pégalas en <head>)",
    copy: "Copiar",
    copied: "¡Copiado!",
    clear: "Limpiar",
  ...
  de: {
    ...
    title: "Favicon-Generator",
    subtitle:
      "Verwandeln Sie ein möglichst quadratisches Bild in ein komplettes Favicon-Set: favicon.ico, PNGs in allen Standardgrößen und die HTML-Tags zum Einfügen. Alles wird in Ihrem Browser erzeugt.",
    drop: "Bild hierher ziehen oder zum Auswählen klicken",
    formats: "PNG, JPG oder WebP — idealerweise 512×512 oder größer",
    generate: "Favicons erzeugen",
    processing: "Wird erzeugt...",
    downloadZip: "ZIP herunterladen",
    preview: "Vorschau",
    htmlTitle: "HTML-Tags (in <head> einfügen)",
    copy: "Kopieren",
    copied: "Kopiert!",
    clear: "Leeren",
  ...
  pt: {
    ...
    subtitle:
      "Transforme qualquer imagem quadrada em um conjunto completo de favicons: favicon.ico, PNGs em todos os tamanhos padrão e as tags HTML prontas para colar. Tudo gerado no seu navegador.",
    drop: "Solte uma imagem aqui ou clique para selecionar",
    formats: "PNG, JPG ou WebP — idealmente 512×512 ou maior",
    generate: "Gerar favicons",
    processing: "Gerando...",
    downloadZip: "Baixar ZIP",
    preview: "Pré-visualização",
    htmlTitle: "Tags HTML (cole dentro de <head>)",
    copy: "Copiar",
    copied: "Copiado!",
    clear: "Limpar",
  ...
  fr: {
    ...
    subtitle:
      "Transformez n'importe quelle image carrée en un jeu complet de favicons : favicon.ico, PNG dans toutes les tailles standard et les balises HTML à coller. Tout est généré dans votre navigateur.",
    drop: "Déposez une image ici ou cliquez pour la sélectionner",
    formats: "PNG, JPG ou WebP — idéalement 512×512 ou plus",
    generate: "Générer les favicons",
    processing: "Génération...",
    downloadZip: "Télécharger le ZIP",
    preview: "Aperçu",
    htmlTitle: "Balises HTML (à coller dans <head>)",
    copy: "Copier",
    copied: "Copié !",
    clear: "Effacer",
