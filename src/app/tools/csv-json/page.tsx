...
const labels = {
  ...
  es: {
    ...
    subtitle:
      "Convierte datos CSV a JSON y viceversa. Admite campos entrecomillados y delimitadores personalizados.",
    csvToJson: "CSV → JSON",
    jsonToCsv: "JSON → CSV",
    ...
    output: "Salida",
    phCsv: "nombre,edad\nAna,30\nLuis,25",
    phJson: '[{"nombre":"Ana","edad":30},{"nombre":"Luis","edad":25}]',
    convert: "Convertir",
    copy: "Copiar",
    copied: "¡Copiado!",
    clear: "Limpiar",
    errCsv: "No se pudo analizar el CSV. Revisa el delimitador y las comillas.",
    errJson: "JSON no válido. Se esperaba un array de objetos planos.",
  },
  de: {
    back: "← Zurück zu den Tools",
    title: "CSV-↔-JSON-Konverter",
    subtitle:
      "Wandeln Sie CSV-Daten in JSON um und zurück. Unterstützt Felder in Anführungszeichen und eigene Trennzeichen.",
    csvToJson: "CSV → JSON",
    jsonToCsv: "JSON → CSV",
    ...
    output: "Ausgabe",
    phCsv: "name,alter\nAnna,30\nJonas,25",
    phJson: '[{"name":"Anna","alter":30},{"name":"Jonas","alter":25}]',
    convert: "Konvertieren",
    copy: "Kopieren",
    copied: "Kopiert!",
    clear: "Leeren",
    errCsv: "CSV konnte nicht gelesen werden. Prüfen Sie Trennzeichen und Anführungszeichen.",
    errJson: "Ungültiges JSON. Erwartet wird ein Array flacher Objekte.",
  },
  pt: {
    back: "← Voltar às ferramentas",
    title: "Conversor CSV ↔ JSON",
    subtitle:
      "Converta dados CSV para JSON e vice-versa. Suporta campos entre aspas e delimitadores personalizados.",
    csvToJson: "CSV → JSON",
    jsonToCsv: "JSON → CSV",
    delimiter: "Delimitador",
    comma: "Vírgula (,)",
    ...
    output: "Saída",
    phCsv: "nome,idade\nAna,30\nBruno,25",
    phJson: '[{"nome":"Ana","idade":30},{"nome":"Bruno","idade":25}]',
    convert: "Converter",
    copy: "Copiar",
    copied: "Copiado!",
    clear: "Limpar",
    errCsv: "Não foi possível ler o CSV. Verifique o delimitador e as aspas.",
    errJson: "JSON inválido. Esperava-se um array de objetos simples.",
  },
  fr: {
    back: "← Retour aux outils",
    title: "Convertisseur CSV ↔ JSON",
    subtitle:
      "Convertissez des données CSV en JSON et inversement. Gère les champs entre guillemets et les délimiteurs personnalisés.",
    csvToJson: "CSV → JSON",
    jsonToCsv: "JSON → CSV",
    ...
    output: "Sortie",
    phCsv: "nom,age\nAlice,30\nHugo,25",
    phJson: '[{"nom":"Alice","age":30},{"nom":"Hugo","age":25}]',
    convert: "Convertir",
    copy: "Copier",
    copied: "Copié !",
    clear: "Effacer",
    errCsv: "Impossible d'analyser le CSV. Vérifiez le délimiteur et les guillemets.",
    errJson: "JSON non valide. Un tableau d'objets simples est attendu.",
  },
};
