...
const labels = {
  ...
  es: {
    ...
    subtitle:
      "Cambia el tamaño de imágenes JPG, PNG y WebP por ancho o por porcentaje. Se conserva la proporción y las imágenes nunca salen de tu navegador.",
    drop: "Suelta las imágenes aquí o haz clic para seleccionarlas",
    formats: "JPG, PNG, WebP — admite varios archivos",
    modeWidth: "Ancho objetivo (px)",
    modePercent: "Escala (%)",
    quality: "Calidad",
  ...
  de: {
    ...
    subtitle:
      "Ändern Sie die Größe von JPG-, PNG- und WebP-Bildern nach Breite oder Prozentwert. Das Seitenverhältnis bleibt erhalten, und die Bilder verlassen Ihren Browser nie.",
    drop: "Bilder hierher ziehen oder zum Auswählen klicken",
    formats: "JPG, PNG, WebP — mehrere Dateien möglich",
    modeWidth: "Zielbreite (px)",
    modePercent: "Skalierung (%)",
    quality: "Qualität",
    resize: "Größe ändern",
  ...
  pt: {
    ...
    subtitle:
      "Redimensione imagens JPG, PNG e WebP por largura ou porcentagem. A proporção é mantida e as imagens nunca saem do seu navegador.",
    drop: "Solte as imagens aqui ou clique para selecionar",
    formats: "JPG, PNG, WebP — vários arquivos suportados",
    modeWidth: "Largura desejada (px)",
    modePercent: "Escala (%)",
    quality: "Qualidade",
    resize: "Redimensionar",
  ...
  fr: {
    ...
    subtitle:
      "Redimensionnez vos images JPG, PNG et WebP par largeur ou par pourcentage. Les proportions sont conservées et les images ne quittent jamais votre navigateur.",
    drop: "Déposez vos images ici ou cliquez pour les sélectionner",
    formats: "JPG, PNG, WebP — plusieurs fichiers pris en charge",
    modeWidth: "Largeur cible (px)",
    modePercent: "Échelle (%)",
    quality: "Qualité",
