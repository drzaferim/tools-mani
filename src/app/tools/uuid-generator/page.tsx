...
const labels = {
  ...
  es: {
    ...
    title: "Generador de UUID y hash de texto",
    subtitle:
      "Genera identificadores UUID v4 aleatorios o calcula hashes criptográficos de cualquier texto. Todo se ejecuta en tu navegador.",
    tabUuid: "UUID v4",
    tabHash: "Hash de texto",
    count: "¿Cuántos?",
    uppercase: "Mayúsculas",
    noHyphens: "Sin guiones",
    generate: "Generar",
    copyAll: "Copiar todo",
    copied: "¡Copiado!",
    hashInput: "Texto para el hash",
    hashPlaceholder: "Escribe o pega cualquier texto...",
    algorithm: "Algoritmo",
    compute: "Calcular hash",
    result: "Resultado",
    copy: "Copiar",
  },
  de: {
    ...
    title: "UUID-Generator & Text-Hash",
    subtitle:
      "Erzeugen Sie zufällige UUID-v4-Kennungen oder berechnen Sie kryptografische Hashes beliebiger Texte. Alles läuft in Ihrem Browser.",
    tabUuid: "UUID v4",
    tabHash: "Text-Hash",
    count: "Wie viele?",
    uppercase: "Großbuchstaben",
    noHyphens: "Ohne Bindestriche",
    generate: "Erzeugen",
    copyAll: "Alle kopieren",
    copied: "Kopiert!",
    hashInput: "Zu hashender Text",
    hashPlaceholder: "Beliebigen Text eingeben oder einfügen...",
    algorithm: "Algorithmus",
    compute: "Hash berechnen",
    result: "Ergebnis",
    copy: "Kopieren",
  },
  pt: {
    back: "← Voltar às ferramentas",
    title: "Gerador de UUID e hash de texto",
    subtitle:
      "Gere identificadores UUID v4 aleatórios ou calcule hashes criptográficos de qualquer texto. Tudo roda no seu navegador.",
    tabUuid: "UUID v4",
    tabHash: "Hash de texto",
    count: "Quantos?",
    uppercase: "Maiúsculas",
    noHyphens: "Sem hifens",
    generate: "Gerar",
    copyAll: "Copiar tudo",
    copied: "Copiado!",
    hashInput: "Texto para o hash",
    hashPlaceholder: "Digite ou cole qualquer texto...",
    algorithm: "Algoritmo",
    compute: "Calcular hash",
    result: "Resultado",
    copy: "Copiar",
  ...
  fr: {
    ...
    title: "Générateur d'UUID et hachage de texte",
    subtitle:
      "Générez des identifiants UUID v4 aléatoires ou calculez des empreintes cryptographiques de n'importe quel texte. Tout s'exécute dans votre navigateur.",
    tabUuid: "UUID v4",
    tabHash: "Hachage de texte",
    count: "Combien ?",
    uppercase: "Majuscules",
    noHyphens: "Sans tirets",
    generate: "Générer",
    copyAll: "Tout copier",
    copied: "Copié !",
    hashInput: "Texte à hacher",
    hashPlaceholder: "Saisissez ou collez n'importe quel texte...",
    algorithm: "Algorithme",
    compute: "Calculer l'empreinte",
    result: "Résultat",
    copy: "Copier",
  },
};
