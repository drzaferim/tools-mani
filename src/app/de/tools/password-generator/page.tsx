...
export const metadata: Metadata = {
  title: "Passwort-Generator - Kostenlos Online | ToolsMani",
  description:
    "Starke, sichere Passwörter mit anpassbarer Länge und Zeichenarten erstellen.",
  alternates: {
    canonical: "/de/tools/password-generator/",
    languages: {
