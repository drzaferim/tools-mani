...
export const metadata: Metadata = {
  title: "Lorem-Ipsum-Generator - Kostenlos Online | ToolsMani",
  description:
    "Platzhaltertext als Absätze, Sätze oder Wörter erzeugen. Perfekt für Mockups.",
  alternates: {
    canonical: "/de/tools/lorem-ipsum/",
    languages: {
